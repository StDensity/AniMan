    ...
    <div>
      ...
      <div className="mx-auto w-[94%] lg:w-[80%]">
        ...
        <p className="mt-4 text-[#bdbdbd]">
          AniMannow.live is committed to respecting the intellectual property
        ...
        <p className="mt-4 text-[#bdbdbd]">
          None of the files listed on AniMannow.live are hosted on our servers. All
          ...
          to{" "}
          <Link href="mailto:matrixsols2024@gmail.com" className="text-white">
            matrixsols2024@gmail.com
          </Link>{" "}
