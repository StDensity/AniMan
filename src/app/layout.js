...
const APP_NAME = "AniMan";
const APP_DEFAULT_TITLE = "AniMan - Watch Anime Online";
const APP_DESCRIPTION = "Discover a world of anime without interruptions on AniMan! Watch your favorite series for free, with no ads to disrupt your viewing experience. Join now and immerse yourself in the captivating stories and vibrant characters that AniMan has to offer!";
